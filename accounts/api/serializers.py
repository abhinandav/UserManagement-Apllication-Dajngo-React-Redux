...
class AdminUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'first_name', 'last_name', 'phone_number', 'email', 'User_Profile','password','is_active','is_superuser']
        extra_kwargs = {
            'password':{ 'write_only':True},
...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['first_name', 'phone_number', 'email', 'is_active','is_superuser']
