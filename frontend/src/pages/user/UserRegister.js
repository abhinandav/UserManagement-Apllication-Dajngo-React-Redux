...
import registerimg3 from '../../images/p3.jpg'
    ...
    <div className="container py-5 " >
      <div className="row d-flex  align-items-center ">
        <div className="col-12 col-md-8 col-lg-6 col-xl-5 d-flex">
            ...
            <div className="card shadow-2-strong col-lg-12" style={{borderRadius: '1rem'}}>
              <div className="card-body p-5 " style={{backgroundColor: "#deefe5"}}>
            ...
            <div className='col-lg-12 col-md-12'>
              <img src={registerimg3} alt='' style={
                {
                  height:600,
                  width:600,
                  marginLeft:150
